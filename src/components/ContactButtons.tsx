  ...
  return (
    <div className="flex flex-wrap gap-2">
      <Button variant={variant} size={size} asChild>
        <a href={`tel:${regionConfig.phone}`} className="flex items-center gap-2">
      ...
      <Button variant={variant} size={size} asChild>
        <a href={`https://wa.me/${regionConfig.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
      ...
      <Button variant={variant} size={size} asChild>
        <a href={`https://t.me/${regionConfig.telegram}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
      ...
      <Button variant={variant} size={size} asChild>
        <a href={`mailto:${regionConfig.email}`} className="flex items-center gap-2">
