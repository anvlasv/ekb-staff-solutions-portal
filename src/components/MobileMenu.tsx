            ...
            <div className="mt-8 px-6">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-brand-700">{regionConfig.phoneDisplay}</div>
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-gray-700">{regionConfig.email}</div>
                ...
                <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">{regionConfig.address}</div>
                  </div>
                </div>
              </div>
